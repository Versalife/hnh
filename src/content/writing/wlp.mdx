---
title: "Word Level Parallelism"
date: 2021-06-01
description: "Exploring bit-level algorithms for parallel operations on packed integers, including parallel compare, tile, rank, and O(1) MSB."
tags: ["algorithms", "bit-manipulation", "rust"]
citationKey: "wlp"
---
...
6. [This StackOverflow Question — scroll down to the answer by `templatetypedef`](https://stackoverflow.com/questions/3878320/understanding-fusion-trees)
